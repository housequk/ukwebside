...
import QHouseSRzut from "../../SVG/QHouseMRzut.svg";
import QHouseSAxo from "../../SVG/QHouseMAxo.svg";
import QHouseSPrzekroj from "../../SVG/QHouseMPrzekroj.svg";
import QHouseSStrefy from "../../SVG/QHouseMStrefy.svg";
import QHouseAxo2lokale from "../../SVG/QHouseM2Axo.svg";
        ...
        <Col s = {12} m = {10} l = {8} push = "m1 l2">
          ...
          <Col s = {12}>
            <Card className = "house2card z-depth-3">
              <Row>
                <Col s = {12} l = {6}>
                  <img alt = "" src = {QHouseAxo2lokale} width = "100%" />
                  
                </Col>
                <Col s = {12} l = {6}>
                  <h3> Version with 2 premises </h3>
                  <div className = "text left-align">
                    The building can be divided into 2 premises with separate entrances
                    and terraces.
                  </div>
                  <Table>
                    <tbody>
          ...
          <Col s = {12}>
            <Card className = "house3card white-text z-depth-3">
              <Row>
                <h3 className = "center"> Miscellaneous plots </h3>
                <div className = "player-wrapper">
                  <ReactPlayer
                    className = "react-player"
                    url = "https://youtu.be/RxrRndao5T4"width = "100%"
                    height = "100%"
                    playing = {false}
                    muted = {true}
                    controls = {true}
        ...
        <Row>
          <Col s={12} m={10} l={8} push="m1 l2">
                  ...
                  <Col s={12} l={6}>
                    ...
                    <div className="center ">
                      <Button node="a" href="zamow" large className="orange">
                        Zamów, przyblizona cena 3947 zł/m2
                      </Button>
                    </div>
                    <br />
                    <div className="center">
            ...
            <Col s={12}>
              <Card className="house2card  z-depth-3">
                <Row>
                  ...
                  <Col s={12} l={6}>
                    <h3>Wersja z 2 lokalami</h3>
                    <div className="text left-align">
                      Budynek można podzielić na 2 lokale, z osobnymi wejściami
                      i tarasami.
                    </div>
                    <Table>
                      <tbody>
            ...
            <Col s={12}>
              <Card className="house3card white-text z-depth-3">
                <Row>
                  <h3 className="center">Rożne działki</h3>
                  <div className="player-wrapper">
                    <ReactPlayer
                      className="react-player"
